  ...
  return (
    <div className="prose prose-lg dark:prose-invert max-w-none space-y-8">
      ...
      <p>
        ...
        complete information. You are responsible for safeguarding the password
      ...
      <p>
        ...
        will remain the exclusive property of next-auth-drizzle-neon-template
        and its licensors.
      </p>
      ...
      <p>
        In no event shall next-auth-drizzle-neon-template, nor its directors,
